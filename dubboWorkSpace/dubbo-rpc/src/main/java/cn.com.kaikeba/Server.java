...
//        serverSocket.setSoTimeout(1000*20);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ZooKeeper zooKeeper = new ZooKeeper("192.168.220.128:2181",1000*3, event -> {
            //zooKeeper 同步连接时 ：zookeeper 已经连接上了
        ...
        //--------------向zookeeper 添加节点 ，添加zookeeper服务提供者的节点（端口号，权重，url）
        /**
         * 跟节点不存在
         */
